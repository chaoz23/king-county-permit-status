...
**Coverage today:** 🟢 **16/39** cities fully live · 🟡 **18/39** electrical-only (via L&I) · 🔴 **5/39** portal-link fallback · plus unincorporated King County. See the coverage scorecard below for the per-city breakdown.
...
**Coverage:** 16/39 live · 18/39 partial (L&I electrical only) · 5/39 fallback. Plus **King County (unincorporated)** for county-level permits (septic, critical areas, grading).
