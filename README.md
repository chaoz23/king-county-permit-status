...
**Coverage today:** 🟢 **15/39** cities fully live · 🟡 **18/39** electrical-only (via L&I) · 🔴 **6/39** portal-link fallback · plus unincorporated King County. See the coverage scorecard below for the per-city breakdown.
...
**Coverage:** 15/39 live · 18/39 partial (L&I electrical only) · 6/39 fallback. Plus **King County (unincorporated)** for county-level permits (septic, critical areas, grading).
