...
**Coverage today:** 🟢 **18/39** cities fully live · 🟡 **16/39** electrical-only (via L&I) · 🔴 **5/39** portal-link fallback · plus unincorporated King County. See the coverage scorecard below for the per-city breakdown.
